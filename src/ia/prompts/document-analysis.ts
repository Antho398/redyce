/**
 * Prompts pour l'analyse générale de documents
 * (Hérité et amélioré depuis lib/ai)
 */

export const DOCUMENT_ANALYSIS_SYSTEM_PROMPT = `Tu es un expert en analyse de documents techniques pour les appels d'offres de construction et rénovation.
