...
import { CheckCircle2, Upload, Sparkles, Eye, Loader2, X, FileText, AlertTriangle, Info, FileType2, File } from 'lucide-react'
    ...
    <TooltipProvider delayDuration={300}>
      <Card className="h-full flex flex-col">
        <CardContent className="p-4 space-y-4 flex-1 flex flex-col">
          ...
          {/* Statut du template avec tooltip */}
          {hasTemplate && (
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center justify-between gap-3 py-2 cursor-help">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    {template?.id && (
                      <Link href={`/projects/${projectId}/documents/${template.id}`} onClick={(e) => e.stopPropagation()}>
                    ...
                    {template?.status === 'PARSED' && (
                      <Link href={`/projects/${projectId}/questions`} onClick={(e) => e.stopPropagation()}>
          ...
          {/* Alerte PDF (conservée pour visibilité importante) */}
          {isPdfTemplate && hasTemplate && (
